...
import { termsOfServiceData, effectiveDate } from '../data/termsOfServiceData';
      ...
      <div className="container mx-auto max-w-4xl px-4 py-8 sm:py-12">
        ...
        <div className="mt-12 pt-8 border-t border-border print:mt-8 print:pt-6">
          <div className="text-center text-sm text-muted-foreground print:text-black">
            <p className="mb-4">
              These Terms of Service are effective as of {effectiveDate} and will remain in effect
