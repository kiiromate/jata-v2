      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-card p-8 rounded-lg shadow-md mb-8">
            <h2 className="text-2xl font-medium mb-4">Step 1: Download the Extension Files</h2>
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-medium mb-4">Step 2: Open Chrome Extensions</h2>
            ...
            <div>
              <h2 className="text-2xl font-medium mb-4">Step 3: Enable Developer Mode</h2>
            ...
            <div>
              <h2 className="text-2xl font-medium mb-4">Step 4: Load the Extension</h2>
            ...
            <div>
              <h2 className="text-2xl font-medium mb-4">Step 5: Select the Folder</h2>
