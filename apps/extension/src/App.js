...
const App = () => {
    ...
    return (_jsxs("div", { className: "w-[400px] bg-gray-900 text-white p-6 font-sans", children: [_jsxs("div", { className: "flex justify-between items-center mb-6", children: [_jsx("h1", { className: "text-2xl font-bold", children: "JATA" }), _jsx("p", { className: "text-sm text-gray-400", children: "Job Application Tracker" })] }), statusMessage && _jsx("p", { className: "text-center text-yellow-400 mb-4", children: statusMessage }), _jsx("div", { className: "space-y-4", children: Object.keys(data).map((key) => (_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-300 capitalize mb-1", children: key.replace(/([A-Z])/g, ' $1') }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("p", { className: "w-full bg-gray-800 border border-gray-700 rounded-md px-3 py-2 text-sm truncate", children: data[key] || `Click 'Select' to capture ${key}` }), _jsx("button", { onClick: () => handleSelect(key), disabled: !!isScraping, className: "px-4 py-2 bg-indigo-600 text-white rounded-md text-sm font-semibold hover:bg-indigo-700 disabled:bg-gray-500 disabled:cursor-not-allowed transition-colors duration-200 whitespace-nowrap", children: "Select" })] })] }, key))) }), _jsx("button", { onClick: handleSave, disabled: !!isScraping, className: "w-full mt-8 bg-green-600 text-white rounded-md py-3 text-base font-semibold hover:bg-green-700 disabled:bg-gray-500 transition-colors duration-200", children: "Save Application" })] }));
};
export default App;
