 ...
 */
export const detectJobBoard = (url: string): JobBoardPattern | null => {
 ...
 */
const extractWithSelectors = (selectors: string[]): string => {
 ...
 */
export const autoExtractJobDetails = (): Partial<JobDetails> => {
 ...
 */
export const detectIndustry = (title: string, description: string): string => {
